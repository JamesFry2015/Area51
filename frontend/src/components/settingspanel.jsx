    ...
    <div className="settings-content-wrapper">
      ...
      <div className="settings-content generation-form">
        ...
        <details className="advanced-dropdown">
          ...
          <div className="toggle-group">
            <label htmlFor="reasoning_toggle">Reasoning - For certain models only</label>
            <input type="checkbox" id="reasoning_toggle" name="reasoning" checked={settings.reasoning} onChange={handleToggle} />
          </div>
        </details>
      </div>
    </div>
